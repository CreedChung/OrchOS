...
export const stateController = new Elysia({ prefix: "/api/goals/:goalId" })
  ...
  .post("/states", ({ params: { goalId }, body }) => {
  ...
  .post("/artifacts", ({ params: { goalId }, body }) => {
    return StateService.createArtifact(goalId, body.name, body.type as any, body.status as any, body.detail)
  }, {
