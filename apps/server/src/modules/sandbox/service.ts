...
interface VMInstance {
  ...
  sessions: Map<
    string,
    { sessionId: string; agentType: string; status: "active" | "closed"; createdAt: string }
  >;
  createdAt: string;
}
...
export abstract class SandboxService {
    ...
    try {
      ...
      const vm = await AgentOs.create({
        ...
        additionalInstructions:
          ...
          "You are an agent running inside OrchOS sandbox. Use /home/user/project for reading project files and /home/user/workspace for writing output.",
      });
  ...
  static getSessionEvents(
    ...
    const events = instance.vm.getSessionEvents(
      sessionId,
