...
import { Shield01Icon, ArrowRight01Icon, ToggleLeft, ToggleRight, Cancel01Icon, Circle, Wrench01Icon, PencilEdit02Icon, CheckmarkCircle02Icon } from "@hugeicons/core-free-icons"
...
function InlineEditField({
  ...
  return (
    ...
    >
      ...
      <HugeiconsIcon icon={PencilEdit02Icon} className="size-3 text-muted-foreground opacity-0 transition-opacity group-hover/edit:opacity-100" />
    </span>
  )
}
...
export function AgentDetailView({
  ...
  onAgentUpdated?: () => void
  onUpdateAgent?: (id: string, data: Partial<{ name: string; role: string; capabilities: string[]; status: AgentProfile["status"]; model: string; enabled: boolean; cliCommand: string; runtimeId: string; avatarUrl: string }>) => Promise<void>
}) {
